...
class DeviceInterface(models.Model):
    ...
    ifName = models.CharField(default="-", max_length=128, verbose_name="接口名", db_comment="接口名")
    ifAlias = models.CharField(default="-", max_length=128, verbose_name="接口别名", db_comment="接口别名")
...
class DeviceARP(models.Model):
    ...
    ifName = models.CharField(default="-", max_length=128, verbose_name="接口名称", db_comment="接口名称")
    ifAlias = models.CharField(default="-", max_length=128, verbose_name="接口别名", db_comment="接口别名")
    ifOperStatus = models.IntegerField(default=1, verbose_name="接口当前的状态", db_comment="接口当前的状态")
